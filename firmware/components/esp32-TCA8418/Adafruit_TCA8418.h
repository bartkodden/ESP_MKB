...
public:
  ...
  bool begin(uint8_t address = TCA8418_DEFAULT_ADDR, i2c_port_t port = I2C_NUM_0); // <- Modified for use in ESP-IDF
...
protected:
  ...
  uint8_t i2c_address; // <- Modified for use in ESP-IDF
  i2c_port_t i2c_port; ///< Store the I2C port number
};
